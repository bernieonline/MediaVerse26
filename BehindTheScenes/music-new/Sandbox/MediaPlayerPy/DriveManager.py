                ...
                if raw_ext in video_exts:
                    ...
                    if self.folder_mapper:
                        ...
                        if record and "cache" in record:
                            ...
                            if rel_cache_path:
                                clean_rel = rel_cache_path.lstrip('\\/')
                                full_path = os.path.join(self.network_root, clean_rel)
                                image_path = "file:///" + full_path.replace("\\", "/")

                    # Fallback to local .jpg
                    if not image_path:
