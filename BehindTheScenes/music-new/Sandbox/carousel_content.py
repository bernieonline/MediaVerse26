...
class CarouselViewWidget(QWidget):
            ...
            for i in range(5):
                ...
                if label.isVisible() and label.geometry().contains(pos):
                    ...
                    if 0 <= img_index < collection_length:
                        ...
                        full_path = os.path.join(self.TEST_MEDIA_FOLDER, file_name)

                        #print("carousel full path is",full_path)
                        
                        
                        
                        constants.selected_image_path=full_path
                        print("carousel content testing constants inside mousepressevent carousel content file_name ",constants.selected_image_path)
                        
                        ##print("carousel file_name is:",file_name)#this is the correct filename
                        # Derive the XML file name (e.g., 'A Bridge Too Far.xml')
                        base_name, _ = os.path.splitext(file_name)
                        #xml_file_name = base_name + ".xml"

                        #print("xxxxxxxxxxxxxxx",base_name)
                        ...
                        #print("carousel inside mousepressevent carousel content xml_path ",xml_path)
    ...
    def get_xml_path(self, base_name):
        ...
        xml_path = os.path.join(self.IMAGE_BASE_PATH, xml_file_name)
        #print("inside mousepressevent-get_xml_path carousel content xml_path ",xml_path)
