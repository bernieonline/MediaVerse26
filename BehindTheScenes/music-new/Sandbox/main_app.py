...
class prototype_pc_monitor(QWidget):
    ...
    # Event handlers
    # ----------------------------
    def _handle_carousel_selection_old(self, media_file_path):
        print("inside _handle_carousel_selection for xml",media_file_path)
        image_file_path=constants.selected_image_path
        print("main_app test constants  inside carousel selection testing image path",image_file_path) #test constants main_app inside carousel selec
    ...
    '''modified to generate carousel single image and revert to maon screen carousel '''
    def _handle_carousel_selection(self, media_file_path):
        """
        Handle click from the carousel.
        Show the selected image full-size on the left,
        ...
        if os.path.exists(constants.selected_image_path):
            ...
            print("ERROR: Image file not found:", constants.selected_image_path)
