...
class createMasterCollection:
    def __init__(self, parent=None, Footer=None, master_progress_bar=None):
        self.parent = parent    #reference to getMainWindow
        self.footer = Footer

        self.search_master_instance = None  # Initialize to None
    ...
    def run(self):
        ...
        logging.info(" inside createMasterCollection new  run()")
        self.window.show()
